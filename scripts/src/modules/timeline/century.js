    ...
    fetch('http://a08001c6c1d2e4c58bdf02589da33fca-0f850b505f873e8e.elb.eu-west-2.amazonaws.com/rosetta/data/search?aggs=decade,year,century&filter=group:community') // Replace with your server-side API endpoint
    ...
    if (!decades.length) {
    console.warn("No records found for decades within the target century.");
    return;
}
    ...
    const url ='./?vis_view=timeline&timeline_type=year&startDate='+ clickedIndexAdjust+'#myChart';
    window.location = url;
