/* eslint-disable camelcase, no-magic-numbers, no-inline-comments, max-lines-per-function, radix, id-length, radix, no-ternary, func-names, no-shadow, no-console, promise/always-return */
